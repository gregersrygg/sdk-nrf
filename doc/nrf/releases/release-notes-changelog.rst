...
* :ref:`nrf_modem_lib_readme` library:
  ...
  * Added:
    ...
    * The trace flash backend that enables the application to store trace data to flash and retrieve the data later.
  ...
  * Updated:
    ...
    * The :ref:`modem_trace_module` to support backends that store the trace data and retrieve the data later.
